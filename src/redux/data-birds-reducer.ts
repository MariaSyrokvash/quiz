...
export type BirdsStateType = Array<BirdType>
type InitialStateType = Array<BirdsStateType>
...
export const birdsDataReducer = (state: InitialStateType = initialState, action: ActionsType): InitialStateType => {
	switch (action.type) {
		default:
			return state
	}
...
type setFirstLevelACType = {
	type: typeof FIRST_LEVEL
}
